 ...
 * on VBIOS version binary :0x03110150  string:3.11.01.50.23 
 * PostSeq runtime options:
 * ..\postseq.exe -i romjaton2.rom -o Jaton2NV11.c -p -a 11 -d 1 
 *
 ...
 */
    ...
    if (freqIndex < 16)
    {
        unsigned short freqTable[16] = {0x445c, 0x445c, 0x2ee0, 0x2ee0, 0x2ee0, 0x2ee0, 0x2ee0, 0x37dc, 0x2ee0, 0x37dc, 0x4e20, 0x445c, 0x4e20, 0x37dc, 0x4e20, 0x37dc, };
 ...
 */
    ...
    if (freqIndex < 16)
    {
        unsigned short freqTable[16] = {0x40d8, 0x40d8, 0x2ee0, 0x2ee0, 0x2ee0, 0x2ee0, 0x2ee0, 0x40d8, 0x36b0, 0x40d8, 0x37dc, 0x40d8, 0x40d8, 0x40d8, 0x40d8, 0x40d8, };
        unsigned int freq = freqTable[freqIndex];
        freq = (doubleFlag) ? freq * 2 : freq;
        /* Program MClock */
 ...
 */
    DvReadPort( MMIO, 0x006013d4 + getCRTCIndex(MMIO), 0x0000003c, &value08 );
    {
        unsigned int dataTable[16] =         {0x43070a0a, 0x43070a0a, 0x33070a0a, 0x33070a0a, 0x33070a0a, 0x33070a0a, 0x33070a0a, 0x34070d0b, 0x34070d0b, 0x34070d0b, 0x33070c0a, 0x44080d0c, 0x34070d0b, 0x33070a0c, 0x34070d0b, 0x34070d0b, };
        value08 = (value08 & 0xf0) >> 0x00000004;
        if (value08 < 16)
        {
            word32 = dataTable[value08];
 ...
 */
    DvReadPort( MMIO, 0x006013d4 + getCRTCIndex(MMIO), 0x0000003c, &value08 );
    {
        unsigned int dataTable[16] =         {0x02211150, 0x02211150, 0x02211150, 0x02211150, 0x02211150, 0x02211150, 0x02211150, 0x02442160, 0x02442160, 0x02442160, 0x03542152, 0x03542152, 0x02432160, 0x02432350, 0x02432160, 0x02442160, };
        value08 = (value08 & 0xf0) >> 0x00000004;
        if (value08 < 16)
        {
            word32 = dataTable[value08];
