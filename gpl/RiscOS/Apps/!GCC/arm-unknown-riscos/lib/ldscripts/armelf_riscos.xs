...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/home/jenkins-slave/workspace/gcc-4.7-native/gcc4/release-area/full/!GCC/arm-unknown-riscos/lib"); SEARCH_DIR("/home/jenkins-slave/workspace/gcc-4.7-native/gcc4/release-area/full/!GCC/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
  ...
  . = ALIGN (0x4) - ((0x4 - .) & (0x4 - 1)); . = DATA_SEGMENT_ALIGN (0x4, 0x4);
  /* Exception handling  */
